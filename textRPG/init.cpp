...
void exploration::enemies_init()
{
	...
	enemy_pool.push_back(new enemy("Szkielet", 15, 0, 2, 5, 0, 0, 0, textures.skeleton, { 42.0f, 1.0f, 72.0f }, 0, 1, "Przed toba stoi otepialy szkielet, chyba czegos broni."));
	enemy_pool.push_back(new enemy("Goblin", 30, 0, 4, 7, 5, 10, 15, textures.goblin, { 62.0f, 1.0f, 24.0f }, 0, 1, "Z krzaka wyskoczyl wsciekly Goblin!!!"));
